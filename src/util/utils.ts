 ...
 */
export const replacer = (translationTable: any) => {
  /**
  ...
  return (str: string) =>
    ...
    str.replace(regExp, (str: string) => translationTable[str]);
};
 ...
 *
 * @param {...Object.<string, string>} let_args One or more objects of strings.
 * @return {!Object.<string, string>} An object of strings.
 */
export const merge = (let_args: any) => {
  const args = [].slice.call(let_args);
  const newObj = Object.create(null);
  let id = 0;
  let key;
